namespace UISystem
{
    ...
    public static class CanvasUtility
    {
        ...
        public static void ShowPopups(PopupName popupName)
        {
            Popup popup = NewViewController.Instance.GetPopup<Popup>(popupName);
            popup.Show();
        }
        public static void HidePopup(PopupName popupName)
        {
            Popup popup = NewViewController.Instance.GetPopup<Popup>(popupName);
            popup.Hide();
        }
